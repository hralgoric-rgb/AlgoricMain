    ...
    if (error || !property) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-white">
                <div className="text-xl text-black mb-4">{error || 'Property not found'}</div>
                <button
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            >
                                <h2 className="text-2xl font-semibold text-black mb-6">Property Overview</h2>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                                    <div className="flex flex-col items-center text-center p-4 bg-black/5 rounded-lg">
                                        ...
                                        <span className="text-xl font-semibold text-black">{property.bedrooms}</span>
                                    </div>
                                    <div className="flex flex-col items-center text-center p-4 bg-black/5 rounded-lg">
                                        <FaBath className="h-6 w-6 text-orange-500 mb-2" />
                                        <span className="text-sm text-black">Bathrooms</span>
                                        <span className="text-xl font-semibold text-black">{property.bathrooms}</span>
                                    </div>
                                    <div className="flex flex-col items-center text-center p-4 bg-black/5 rounded-lg">
                                        <FaRulerCombined className="h-6 w-6 text-orange-500 mb-2" />
                                        <span className="text-sm text-black">Area</span>
                                        <span className="text-xl font-semibold text-black">{property.area} sqft</span>
                                    </div>

                                </div>
                                {property.amenities && property.amenities.length > 0 && (
                                    <div className='mb-4'>
                                        <h4 className="font-medium mb-2 text-orange-500">Amenities</h4>
                                        <div className="flex flex-wrap gap-2">
                                            {property.amenities.map((amenity, index) => (
                                                <span key={index} className="inline-flex items-center p-2 rounded text-sm font-medium bg-orange-700 text-white">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-black font-medium">{property.propertyType}</p>
                                        </div>
                                    </div>
                            ...
                            <motion.div
                                ...
                                className="bg-white p-8 rounded-xl shadow-lg border border-black/10"
                            >
                                <h2 className="text-2xl font-semibold text-black mb-6">Property Gallery</h2>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {property.images.slice(0, 6).map((img, index) => (
                                        <div key={index} className="relative aspect-[4/3] rounded-lg overflow-hidden border border-black/10">
                                            <Image
                                                src={`${img}`}
                            ...
                            >
                                ...
                                <div className="flex items-center mb-4">
                                    <div className="h-12 w-12 bg-black/10 rounded-full flex items-center justify-center mr-3">
                                        <span className="text-black font-medium">{property.owner.name[0] || "PO"}</span>
                                    </div>
                                    <div>
                                        <p className="font-medium text-black">{property.owner.name || "property.owner.name"}</p>
                                        <p className="text-sm text-black/70">{property.ownerDetails.phone || 'Contact via phone'}</p>
                                    </div>
                                </div>
                            </motion.div>
...
<motion.div
    ...
    className="bg-white p-6 rounded-xl shadow-lg border border-black/10"
>
    <h3 className="text-xl font-semibold text-black mb-4">Interested in this property?</h3>

    {contactFormSuccess ? (
        <div className="p-4 bg-orange-50 rounded-md text-black mb-4 border border-orange-500/20">
            <p className="font-medium">Thank you for your inquiry!</p>
            <p className="text-sm mt-1">The owner will contact you shortly.</p>
        </div>
    ) : (
        <form onSubmit={handleContactFormSubmit} className="space-y-4">
            ...
            <div>
                <label htmlFor="email" className="text-black text-sm mb-1 block">Email Address</label>
                <input
                    type="email"
                    id="email"
                    name="email"
            ...
            <div>
                <label htmlFor="phone" className="text-black text-sm mb-1 block">Phone Number</label>
                <input
                    type="tel"
                    id="phone"
                    name="phone"
            ...
            <div>
                <label htmlFor="message" className="text-black text-sm mb-1 block">Message</label>
                <textarea
                    id="message"
                    name="message"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {similarProperties.map((property) => (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        <h3 className="text-lg font-medium text-black line-clamp-1">{property.title}</h3>
                                        ...
                                        <div className="mt-4 flex items-center justify-between">
                                            <div className="text-orange-500 font-medium">₹{property.price.toLocaleString()}</div>
                                            <a
