...
import { Home, Upload, Clock, Users, CheckCircle, MapPin, PenTool, ArrowRight, Phone, Shield, DollarSign, Zap } from "lucide-react";
...
export default function SellProperty() {
  ...
  const handleFormSubmit = async (data: PropertyData) => {
    try {
      ...
      const existingProperties = JSON.parse(sessionStorage.getItem('properties') || '[]');
      const newProperty = {
        ...data,
      ...
      sessionStorage.setItem('properties', JSON.stringify([...existingProperties, newProperty]));
  ...
  const steps = [
    {
      ...
      description: "Sign up and complete your profile with your contact information",
    ...
    },
    {
      ...
      description: "Add property details, photos, amenities, and set your price",
    ...
    {
      title: "Get Verified",
      description: "Our team reviews and verifies your listing for quality assurance",
    ...
    },
    {
      ...
      description: "Receive inquiries and connect directly with interested buyers",
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h3 className="text-5xl font-bold text-white mb-1">{stat.value}</h3>
      ...
      <section className="py-20 px-4 relative bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-16">
            We make selling or renting properties easier than ever before with our powerful platform
          </p>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Follow these simple steps to list your property and start connecting with potential buyers
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-10">
            <div>
              ...
              <p className="text-gray-400 mt-2">Properties recently sold on our platform</p>
            </div>
                ...
                <div className="bg-gradient-to-br from-gray-900 to-black rounded-xl overflow-hidden border border-white/10">
                  ...
                  <div className="p-5">
                    <h3 className="text-lg font-semibold text-white mb-1 group-hover:text-orange-500 transition-colors">
                      {["Luxury Apartment", "Modern Villa", "Spacious House"][item-1]} in {["Mumbai", "Delhi", "Bangalore"][item-1]}
                    </h3>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              Join thousands of successful property sellers on 100Gaj. Start your journey today!
            </p>
            <Button
