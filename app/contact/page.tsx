            ...
            <section className="py-24 bg-white relative overflow-hidden" id="customer-service">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            At EstateElite, we are dedicated to providing exceptional customer service. Our approach is centered around understanding your unique needs and delivering personalized solutions that exceed your expectations.
                        </motion.p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-gradient-to-b from-zinc-900 to-black relative overflow-hidden" id="testimonials">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            {
                                quote: "The EstateElite team made the process of finding our dream home effortless. Their attention to detail and personalized service were exceptional.",
                                author: "Rahul Sharma",
                                role: "Homeowner",
                            },
                            {
                                quote: "As a first-time buyer, I was nervous, but EstateElite guided me through every step. I couldn't be happier with my new home.",
                                author: "Priya Patel",
                                role: "First-time Buyer",
                            },
                            {
                                quote: "Selling my property was quick and hassle-free thanks to EstateElite. Their professionalism and market knowledge are unmatched.",
