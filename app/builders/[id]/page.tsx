        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center py-20">
            ...
            <p className="mt-4 text-white text-2xl">
              The builder you&apos;re looking for doesn&apos;t exist or has been
              removed.
            </p>
            <Link
              href="/builders"
              className="mt-6 inline-block px-6 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-800 transition-colors"
            >
              Back to Builders
            </Link>
          </div>
                        ...
                        {builder.projects_list.map((project, index) => (
                          <tr key={index} className="hover:bg-gray-50">
                            ...
                            <td className="py-3 px-4">
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${project.status === "Completed" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                              >
                                {project.status}
                              </span>
                            </td>
                ...
                {showReviewForm && (
                  <div className="bg-gray-100 rounded-lg p-6 mb-8">
                    ...
                    <form onSubmit={handleSubmitReview}>
                      <div className="mb-4">
                        <label className="block text-orange-600 mb-2">
                          Your Name
                        </label>
                        <input
                          type="text"
