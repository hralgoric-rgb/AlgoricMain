...
export default function AgentsPage() {
  ...
  const specializations = filters.specializations.length > 0 
    ? ['all', ...filters.specializations] 
    : ['all', 'residential', 'luxury', 'commercial', 'investment', 'new construction', 'rental'];
    ...
    <main className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          >
            <div className="inline-block bg-orange-500/80 backdrop-blur-sm px-6 py-2 rounded-full mb-6">
              <span className="text-white font-medium tracking-wider text-sm">MEET OUR PROFESSIONALS</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Our elite team of real estate professionals combines local expertise with global connections to serve your property needs.
            </p>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 -mt-20 relative z-10">
        ...
        >
          <div className="p-6 md:p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Find the Right Agent for You</h2>
            ...
            <div className="flex flex-wrap gap-3">
              {specializations.map((spec) => (
                ...
                >
                  {spec === 'all' ? 'All Agents' : spec.charAt(0).toUpperCase() + spec.slice(1)}
                </button>
              ))}
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12 text-center">
          ...
          >
            Each agent brings unique expertise and local market knowledge to help you achieve your real estate goals.
          </motion.p>
        </div>
        ...
        {loading ? (
                ...
                <div className="h-80 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-white text-sm font-medium">{agent.agentInfo.rating.toFixed(1)}</span>
                      <span className="text-gray-300 text-sm ml-2">{agent.agentInfo.properties || '0'} properties</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  <div className="mb-4">
                    <Link href={`/agents/${agent._id}`}>
                      <h3 className="text-xl font-bold text-white hover:text-orange-500 transition-colors">{agent.name}</h3>
                    </Link>
                    <p className="text-orange-400 text-sm">{agent.agentInfo.role || 'Real Estate Agent'}</p>
                  </div>
                  ...
                  <p className="text-gray-400 text-sm mb-6 line-clamp-2">{agent.bio || `Experienced ${agent.agentInfo.role || 'real estate agent'} specializing in ${agent.agentInfo.specializations?.join(', ') || 'property sales and acquisition'}.`}</p>
          ...
          >
            <div className="max-w-md mx-auto">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 h-16 mx-auto text-orange-500/40">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75l-2.489-2.489m0 0a3.375 3.375 0 10-4.773-4.773 3.375 3.375 0 004.774 4.774zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <h3 className="mt-6 text-xl font-medium text-orange-500">No matching agents found</h3>
              <p className="mt-3 text-gray-500">Try adjusting your search criteria or filters</p>
              <button 
                onClick={() => {
                  setSearchTerm('');
                  setActiveFilter('all');
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <motion.div
              ...
              className="p-6"
            >
              <div className="text-4xl font-bold text-orange-500 mb-2">{agents.reduce((total, agent) => total + agent.agentInfo.experience, 0)}+</div>
        ...
        >
          <div className="relative p-12 text-center">
            ...
            <p className="text-white/90 max-w-2xl mx-auto mb-8 text-lg">
              Whether you`&apos;`re buying, selling, or investing, our agents will guide you through every step of the process.
            </p>
