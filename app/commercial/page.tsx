...
export default function CommercialListingsPage() {
  const [properties, setProperties] = useState<CommercialProperty[]>(mockCommercialProperties);
  const [filteredProperties, setFilteredProperties] = useState<CommercialProperty[]>(mockCommercialProperties);
