        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-dark relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
                        <div className="max-w-5xl mx-auto">
                            <div className="relative">
                                <h1 className="hero-title text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-bold mb-6 sm:mb-8 leading-tight">
                                    Elevate Your{" "}
                                ...
                                <div className="absolute -top-4 sm:-top-8 -left-4 sm:-left-8 w-3 h-3 sm:w-4 sm:h-4 bg-orange-400 rounded-full opacity-60"></div>
                                <div className="absolute -top-2 sm:-top-4 -right-6 sm:-right-12 w-2 h-2 sm:w-3 sm:h-3 bg-orange-500 rounded-full opacity-80"></div>
                                <div className="absolute -bottom-3 sm:-bottom-6 left-1/4 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-orange-300 rounded-full opacity-70"></div>
                            </div>

                            <p className="hero-subtitle text-base sm:text-lg md:text-xl text-white mb-12 sm:mb-16 max-w-3xl mx-auto leading-relaxed px-2">
                            ...
                            <div className="flex flex-col gap-4 sm:gap-6 justify-center items-center px-4">
                                <Button
                                    ...
                                    className="group relative w-full max-w-sm sm:w-auto border-2 border-primary-orange/40 text-primary-orange px-6 sm:px-10 py-5 sm:py-7 rounded-2xl font-bold text-base sm:text-lg transition-all duration-700 overflow-hidden backdrop-blur-sm shadow-lg hover:shadow-primary-orange/30 transform hover:-translate-y-2 hover:scale-105"
                                >
                                    ...
                                    <span className="relative z-10 flex items-center gap-2 sm:gap-3 group-hover:text-white transition-colors duration-700">
                                        <Building className="w-5 h-5 sm:w-6 sm:h-6 transform group-hover:rotate-12 transition-transform duration-500" />
                                        <span className="text-sm sm:text-base">Landlord Dashboard</span>
                                    </span>

                                    <div className="absolute top-1 sm:top-2 right-1 sm:right-2 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-orange-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                    <div className="absolute bottom-1 sm:bottom-2 left-1 sm:left-2 w-1 h-1 sm:w-1.5 sm:h-1.5 bg-orange-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                                </Button>
                                ...
                                >
                                    ...
                                    <span className="relative z-10 flex items-center gap-2 sm:gap-3 group-hover:text-white transition-colors duration-700">
                                        <Users className="w-5 h-5 sm:w-6 sm:h-6 transform group-hover:-rotate-12 transition-transform duration-500" />
                                        <span className="text-sm sm:text-base">Tenant Portal</span>
                                    </span>

                                    <div className="absolute top-1 sm:top-2 left-1 sm:left-2 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-orange-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                    <div className="absolute bottom-1 sm:bottom-2 right-1 sm:right-2 w-1 h-1 sm:w-1.5 sm:h-1.5 bg-orange-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                                </Button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
                            {features.map((feature, idx) => {
                                ...
                                return (
                                    <div
                                        key={feature.title}
                                        className={`feature-card min-h-[240px] sm:min-h-[260px] w-full max-w-sm mx-auto sm:max-w-none border-2 ${color.border} rounded-2xl shadow-xl p-6 sm:p-8 flex flex-col items-center text-center transition-all duration-300 hover:scale-105 group ${color.shadow}`}
                                    >
                                        {/* Icon in colored circle, now inside the card and not clipped */}
                                        <div className="mb-4 sm:mb-6 -mt-8 sm:-mt-12 z-10">
                                            <div className={`w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center rounded-full ${color.bg} shadow-lg border-4 border-white/30`}>
                                                <feature.icon className="text-white text-2xl sm:text-3xl" />
                                            </div>
                                        </div>
                                        <h3 className="text-lg sm:text-2xl font-bold text-white mb-2">{feature.title}</h3>
                                        <p className="text-gray-200 text-sm sm:text-base font-medium leading-relaxed">{feature.description}</p>
                                    </div>
                                );
                            })}
                        </div>
                ...
                <section className="relative z-10 bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
                    ...
                    <div className="w-full px-4 sm:px-6 py-16 sm:py-24 text-center relative z-10">
                        <div className="max-w-4xl mx-auto">
                            <div className="relative">
                                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-6 sm:mb-8">
                                    Ready to{" "}
                                ...
                                <div className="absolute -top-2 sm:-top-4 -right-4 sm:-right-8 w-2 h-2 sm:w-3 sm:h-3 bg-orange-400 rounded-full"></div>
                                <div className="absolute -bottom-2 sm:-bottom-4 -left-3 sm:-left-6 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-orange-500 rounded-full"></div>
                            </div>
                            ...
                            <div className="flex flex-col gap-4 justify-center items-center px-4">
                                <Button
                                    size="lg"
                                    className="group relative bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-white font-bold px-8 sm:px-10 py-5 sm:py-6 text-base sm:text-lg rounded-2xl shadow-2xl hover:shadow-orange-500/30 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 border border-orange-500/20 overflow-hidden w-full max-w-sm sm:w-auto"
                                ...
                                >
                                    ...
                                    <div className="absolute -top-1 -right-1 w-4 h-4 sm:w-6 sm:h-6 bg-white/20 rounded-full group-hover:scale-125 transition-transform duration-500 opacity-80"></div>
                                </Button>
                                ...
                                <Button
                                    ...
                                    className="group relative border-2 border-orange-500/30 text-orange-500 hover:bg-orange-500/10 hover:border-orange-500 px-8 sm:px-10 py-5 sm:py-6 text-base sm:text-lg rounded-2xl font-semibold transition-all duration-300 backdrop-blur-sm hover:shadow-lg hover:shadow-orange-500/20 transform hover:-translate-y-1 w-full max-w-sm sm:w-auto"
                                >
                                    <span className="relative z-10 flex items-center gap-2">
