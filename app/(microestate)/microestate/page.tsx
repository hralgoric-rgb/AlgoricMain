                    ...
                    <div className="container mx-auto px-6 text-center relative z-10">
                        <div className="max-w-5xl mx-auto">
                            <div className="relative">
                                ...
                                <div className="absolute -top-4 -right-12 w-3 h-3 bg-orange-500 rounded-full opacity-80"></div>
                                <div className="absolute -bottom-6 left-1/4 w-2 h-2 bg-orange-300 rounded-full opacity-70"></div>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                                ...
                                >
                                    ...
                                    <div className="absolute top-2 right-2 w-2 h-2 bg-orange-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                    <div className="absolute bottom-2 left-2 w-1.5 h-1.5 bg-orange-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                                </Button>
                                ...
                                >
                                    ...
                                    <div className="absolute top-2 left-2 w-2 h-2 bg-orange-300 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                    <div className="absolute bottom-2 right-2 w-1.5 h-1.5 bg-orange-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                                </Button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full px-6 py-24 text-center relative z-10">
                        <div className="max-w-4xl mx-auto">
                            <div className="relative">
                                ...
                                <div className="absolute -top-4 -right-8 w-3 h-3 bg-orange-400 rounded-full"></div>
                                <div className="absolute -bottom-4 -left-6 w-2 h-2 bg-orange-500 rounded-full"></div>
                            </div>
