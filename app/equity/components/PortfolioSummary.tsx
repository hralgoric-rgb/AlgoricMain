	...
	return (
		...
		>
			...
			<motion.div
				...
				style={{
					backgroundImage:
						"radial-gradient(circle at 20% 30%, rgba(251, 146, 60, 0.4) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(239, 68, 68, 0.4) 0%, transparent 50%)",
					...
					<div className='flex items-center gap-3 mb-2'>
						...
						<div>
							...
							<p className='text-gray-400'>
								Your commercial real estate investment overview
							</p>
						</div>
					</div>
				</motion.div>
			...
			>
				...
				<motion.div className='absolute inset-0 bg-gradient-to-r from-green-500/5 to-orange-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700' />
				...
				<div className='relative z-10'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-8'>
						...
						>
							...
							<div className='flex items-center gap-3'>
								...
								>
									{portfolio.averageYield
										? portfolio.averageYield.toFixed(1)
										: portfolio.totalInvestment > 0
										? (
												((portfolio.monthlyIncome * 12) /
					...
					{((portfolio.bestPerformer && portfolio.bestPerformer !== "") ||
						(portfolio.worstPerformer && portfolio.worstPerformer !== "")) && (
						<div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-8'>
							{portfolio.bestPerformer && portfolio.bestPerformer !== "" && (
								<motion.div
									whileHover={{ scale: 1.02 }}
									className='p-4 rounded-xl bg-green-500/10 backdrop-blur-sm border border-green-500/30'
								>
							...
							{portfolio.worstPerformer && portfolio.worstPerformer !== "" && (
								<motion.div
									whileHover={{ scale: 1.02 }}
									className='p-4 rounded-xl bg-red-500/10 backdrop-blur-sm border border-red-500/30'
								>
									<div className='text-sm text-gray-400 mb-2 flex items-center gap-2'>
...
>>>>>>> 33db099f5febf9cc5ab0a320c7bc82d6376cfcb3
}
