...
export default function PostPropertyDashboard() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      router.replace("/equity/login-signup?redirect=/equity/property/post-dashboard");
      return;
    }
      ...
      <div className="container mx-auto px-4 py-8 pt-24 relative z-10">
        ...
        >
          ...
          >
            ...
            <p className="text-purple-200 text-xl font-medium">Complete the verification steps to post your property</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-gray-300 text-sm mb-4">
                {kycStatus === "accepted" && "Your KYC has been approved. You can now proceed with OTP verification."}
                {kycStatus === "pending" && "Your KYC is currently under review. Please wait for admin approval."}
                {kycStatus === "rejected" && "Your KYC was rejected. Please contact support for assistance."}
                {kycStatus === null && "Please complete your KYC verification first to post properties."}
              </p>
            ...
            >
              ...
              <p className="text-gray-300 text-sm mb-4">
                {otpVerified && "Your OTP has been verified. You can now post your property."}
                {!otpVerified && kycStatus === "accepted" && "Click 'Send OTP' to receive a verification code on your email."}
                {!otpVerified && kycStatus !== "accepted" && "Complete KYC verification first to proceed with OTP."}
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 mt-2">
                <Button
                  ...
                  className="flex-1 backdrop-blur-xl bg-gradient-to-r from-purple-600/80 to-blue-600/80 hover:from-purple-500/90 hover:to-blue-500/90 text-white px-4 py-2 rounded-xl border border-white/20 transition-all duration-300 shadow-lg shadow-purple-500/25 disabled:opacity-50"
                >
                  {otpLoading ? "Sending..." : resendDisabled ? "Resend OTP (wait...)" : "Resend OTP"}
                </Button>
              </div>
            </div>
          </motion.div>
