          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            <div className="w-full lg:w-1/2 mt-12 lg:mt-0">
              <div className="text-center lg:text-left mb-8 px-4 lg:px-0">
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-orange-600 to-orange-400 bg-clip-text text-transparent">
                  Choose from Our Collection
                </h2>
                <p className="text-base md:text-xl text-gray-300 mt-4 max-w-2xl mx-auto lg:mx-0 px-4 lg:px-0">
                ...
                <div className="mt-8 space-y-6 md:space-y-8 px-4 lg:px-0">
                  <div className="relative p-6 rounded-xl bg-gradient-to-br from-black to-zinc-900 border border-orange-500/10">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 ">
          <div className="text-center mb-8 md:mb-12 px-4 md:px-0">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 px-4 md:px-0">
              Trending Localities
            </h2>
            <p className="text-base md:text-lg text-gray-300 max-w-2xl mx-auto px-4 md:px-0">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto mt-10 md:mt-20 px-4 md:px-0">
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-lg border border-white/10 hover:border-orange-500/30 transition-all duration-300">
