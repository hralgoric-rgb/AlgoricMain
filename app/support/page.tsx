  ...
  return (
    <main className="min-h-screen bg-stone-light">
          ...
          <div className="max-w-3xl text-center mx-auto">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 drop-shadow-sm">
                Welcome to Our <span className="text-orange-500">Support Center</span> 
              </h1>
            </motion.div>
      ...
      <section className="py-24 bg-black relative overflow-hidden" id="faq">
        ...
        <div className="absolute right-0 bottom-1/3 w-28 h-28 text-brown/10 transform translate-x-1/2 -rotate-12">
          <HouseIcon />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-block bg-orange-500/50 px-4 py-2 rounded-full mb-4"
            >
          ...
          <div className="space-y-6">
            {[
              ...
              >
                <h3 className="text-xl font-semibold text-black mb-2">{faq.question}</h3>
      ...
      <section className="py-24 bg-orange-500 relative overflow-hidden" id="contact-support">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <span className="text-orange-400 font-medium">CONTACT SUPPORT</span>
            </motion.div>
      ...
      <section className="py-24 bg-black relative overflow-hidden" id="additional-resources">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            >
              <span className="text-orange-400 font-medium">RESOURCES</span>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <h3 className="text-xl font-semibold text-orange-700 mb-4">{resource.title}</h3>
                <p className="text-black/80">{resource.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
